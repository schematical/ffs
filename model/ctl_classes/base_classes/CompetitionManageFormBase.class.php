...
class CompetitionManageFormBase extends FFSForm {
    ...
    public function InitEditPanel($objCompetition = null) {
        ...
        $this->AddWidget(((is_null($objCompetition)) ? 'Create Competition' : 'Edit Competition') , 'icon-edit', $this->pnlEdit);
    }
    public function InitList($arrCompetitions) {
        ...
        $this->AddWidget('Competitions', 'icon-ul', $this->lstCompetitions);
    }
