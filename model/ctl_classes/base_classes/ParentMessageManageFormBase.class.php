...
class ParentMessageManageFormBase extends FFSForm {
    ...
    public function InitEditPanel($objParentMessage = null) {
        ...
        $this->AddWidget(((is_null($objParentMessage)) ? 'Create ParentMessage' : 'Edit ParentMessage') , 'icon-edit', $this->pnlEdit);
    }
    public function InitList($arrParentMessages) {
        ...
        $this->AddWidget('ParentMessages', 'icon-ul', $this->lstParentMessages);
    }
