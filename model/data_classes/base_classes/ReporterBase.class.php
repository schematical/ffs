...
* - __set()
* Classes list:
* - ReporterBase extends BaseEntity
*/
class ReporterBase extends BaseEntity {
    ...
    public static function Parse($mixData, $blnReturnId = false) {
        ...
        } elseif ((is_object($mixData)) && (get_class($mixData) == 'Reporter')) {
            if (!$blnReturnId) {
                return $mixData;
            }
    ...
    public function __toArray() {
        ...
        $arrReturn['mediaOutlet'] = $this->mediaOutlet;
        return $arrReturn;
    }
    ...
    public function __get($strName) {
        switch ($strName) {
            ...
            case ('MediaOutlet'):
            case ('mediaOutlet'):
                if (array_key_exists('mediaOutlet', $this->arrDBFields)) {
                    return $this->arrDBFields['mediaOutlet'];
                }
                return null;
            break;
                defualt:
        ...
        public function __set($strName, $strValue) {
            ...
            switch ($strName) {
                ...
                case ('MediaOutlet'):
                case ('mediaOutlet'):
                    $this->arrDBFields['mediaOutlet'] = $strValue;
                break;
                    defualt:
                        throw new Exception('No property with name "' . $strName . '" exists in class ". get_class($this) . "');
                    break;
